...
public interface IDatabaseBackupArchiveValidator
{
    Task ValidateHeaderAsync(
        string filePath,
        CancellationToken cancellationToken);
}

public sealed class DatabaseBackupArchiveValidator
    : IDatabaseBackupArchiveValidator
{
